...
if (isset($_POST['product'])) {
    ...
    if (empty($errors)) {
        ...
        if ($result && $db->affected_rows() === 1) {
            ...
            redirect('edit_stock.php?id=' . $product['id'], false);
        }
    } else {
...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-7">
                <form method="post" action="edit_stock.php?id=<?php echo (int)$product['id'] ?>">
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="glyphicon glyphicon-th-large"></i>
                            </span>
                            <input readonly type="text" class="form-control" name="product-title" value="<?php echo remove_junk($product['name']); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="qty">Stock in / Stock out</label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
